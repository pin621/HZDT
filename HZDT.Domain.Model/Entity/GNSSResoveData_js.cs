...
{
    /// <summary>
    /// 数据表实体类：GNSSResoveData_js 
    /// </summary>
    [Serializable()]
    public class GNSSResoveData_js : IEntity
    {    
		...
		/// Decimal:水平单次变化量
		/// </summary>                       
		public Decimal spdcbhl { get;set;}         
		/// <summary>
		/// Decimal:垂直单次变化量
		/// </summary>                       
		public Decimal czdcbhl { get;set;}         
		/// <summary>
		/// Decimal:水平累计变化量
		/// </summary>                       
		public Decimal spljbhl { get;set;}         
		/// <summary>
		/// Decimal:垂直累计变化量
		/// </summary>                       
		public Decimal czljbhl { get;set;}         
		/// <summary>
